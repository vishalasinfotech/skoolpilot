                ...
                <tbody>
                    @forelse($sections as $index => $section)
                        <tr wire:key="section-{{ $section->id }}">
                            <td>
                                <input type="checkbox" wire:model.live="selectedRows" value="{{ $section->id }}" class="form-check-input">
                            </td>
                            <td>{{ str_pad($sections->firstItem() + $index, 2, '0', STR_PAD_LEFT) }}</td>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <button class="dropdown-item text-danger" wire:click="openDeleteModal({{ $section->id }}, '{{ $section->name }}')">
