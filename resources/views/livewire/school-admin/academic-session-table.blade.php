            ...
            <table class="table table-bordered table-nowrap align-middle mb-0">
                ...
                <tbody>
                    @forelse($academicSessions as $index => $session)
                        <tr wire:key="academic-session-{{ $session->id }}">
                            <td>
                                <input type="checkbox" wire:model.live="selectedRows" value="{{ $session->id }}" class="form-check-input">
                            </td>
                            <td>{{ str_pad($academicSessions->firstItem() + $index, 2, '0', STR_PAD_LEFT) }}</td>
                            <td>
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li>
                                            <button class="dropdown-item text-danger" wire:click="openDeleteModal({{ $session->id }}, '{{ $session->name }}')">
