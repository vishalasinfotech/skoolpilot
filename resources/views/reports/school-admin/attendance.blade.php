        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{ route('reports.school-admin.attendance') }}" class="row g-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2 d-flex align-items-end">
                                    ...
                                    <a href="{{ route('reports.school-admin.attendance') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </form>
                        </div>
                    </div>
