...
@section('title', __('common.edit_language'))
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">{{ __('common.edit_language') }}</h5>
                            <a href="{{ route('super-admin.language.index') }}" class="btn btn-secondary btn-sm">
                                <i class="ri-arrow-left-line"></i> {{ __('common.cancel') }}
                            </a>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('super-admin.language.update', $language) }}" method="POST">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" 
                                                   ...
                                                   @if($language->is_default) disabled @endif>
                                        ...
                                        @if($language->is_default)
                                            <small class="form-text text-muted text-warning">
                                                <i class="ri-information-line"></i> {{ __('common.cannot_deactivate_default_language') }}
                                            </small>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" 
                                                   ...
                                                   @if(!$language->is_active && !$language->is_default) disabled @endif>
