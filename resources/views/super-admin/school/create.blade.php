            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add School</h4>
                ...
                <div class="col-lg-12 col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">Create School</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('super-admin.school.store') }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="address" id="address" rows="3"
                                            placeholder="Enter address">{{ old('address') }}</x-textarea>
                                        @error('address')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-select name="subscription_plan_id" id="subscription_plan_id" :options="$subscriptionPlans->pluck('name', 'id')"
                                            :value="old('subscription_plan_id')" placeholder="Select Plan" />
                                ...
                                <div class="d-flex justify-content-start gap-2">
                                    ...
                                    <a href="{{ route('super-admin.school.index') }}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
