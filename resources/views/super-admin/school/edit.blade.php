...
@section('title', __('common.edit_school'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ __('common.edit_school') }}</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('common.pages') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('common.edit_school') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-10 mx-auto">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">{{ __('common.edit_school') }}</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('super-admin.school.update', $school->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="address" id="address" rows="3" :value="old('address', $school->address)"
                                            placeholder="{{ __('common.enter_address') }}"></x-textarea>
                                        @error('address')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-select name="subscription_plan_id" id="subscription_plan_id" :options="$subscriptionPlans->pluck('name', 'id')"
                                            :value="old('subscription_plan_id', $school->subscription_plan_id)" placeholder="{{ __('common.select_plan') }}" />
                                ...
                                <div class="form-check form-switch form-switch-md mb-3">
                                    ...
                                    <label class="form-check-label ms-2" for="edit-school-status">{{ __('common.status') }}</label>
                                </div>
                                @error('status')
                                    <small class="text-danger d-block">{{ $message }}</small>
                                @enderror
                                ...
                                <div class="d-flex justify-content-start gap-2">
                                    <button type="submit" class="btn btn-primary">{{ __('common.update_school') }}</button>
