                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('school-admin.event.create') }}" class="btn btn-primary">
                                <i class="ri-add-line align-middle me-1"></i> Add Event
                            </a>
                        </div>
                        @livewire('school-admin.event-table')
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('livewire:init', function () {
            ...
            Livewire.on('openDeleteModal', (data) => {
                deleteEventId = data[0].eventId;
                document.getElementById('deleteEventTitle').textContent = data[0].eventTitle;
            ...
            document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
                if (deleteEventId) {
                    ...
                    if (livewireElement) {
                        ...
                        if (component) {
                            component.call('delete', deleteEventId);
