            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Edit Notification Template</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('school-admin.notification-template.update', $notificationTemplate) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-input type="text" name="name" id="name" :value="old('name', $notificationTemplate->name)" required autofocus placeholder="Enter template name" />
                                        @error('name')
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-input type="text" name="subject" id="subject" :value="old('subject', $notificationTemplate->subject)" required placeholder="Enter email subject" />
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="body" id="body" rows="10" required placeholder="Enter email body">{{ old('body', $notificationTemplate->body) }}</x-textarea>
                                ...
                                <div class="form-check form-switch form-switch-md mb-3">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $notificationTemplate->is_active) ? 'checked' : '' }}>
