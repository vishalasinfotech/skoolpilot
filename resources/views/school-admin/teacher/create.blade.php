            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Teacher</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">Create Teacher</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('school-admin.teacher.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-input type="date" name="joining_date" id="joining_date" :value="old('joining_date')" />
                                        @error('joining_date')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="qualification" id="qualification" :value="old('qualification')" placeholder="e.g., B.Ed, M.Ed" />
                                        @error('qualification')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="specialization" id="specialization" :value="old('specialization')" placeholder="e.g., Mathematics, Science" />
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="number" name="salary" id="salary" :value="old('salary')" placeholder="0.00" step="0.01" min="0" />
                                        @error('salary')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
