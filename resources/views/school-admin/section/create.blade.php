                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">Create Section</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('school-admin.section.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="name" id="name" :value="old('name')" required autofocus placeholder="Enter section name (e.g., A, B, C)" />
                                        @error('name')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="short_code" id="short_code" :value="old('short_code')" placeholder="Enter short code (e.g., SEC-A)" />
                                        @error('short_code')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="description" id="description" rows="3" placeholder="Enter section description">{{ old('description') }}</x-textarea>
                                        @error('description')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
