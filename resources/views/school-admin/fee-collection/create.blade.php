                                ...
                                <div id="online_fields" style="display: none;">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <x-input type="text" name="upi_name" id="upi_name" :value="old('upi_name')" placeholder="Enter UPI name" />
                                            @error('upi_name')
                                                <small class="text-danger d-block">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <x-input type="text" name="upi_id" id="upi_id" :value="old('upi_id')" placeholder="Enter UPI ID" />
                                            @error('upi_id')
                                                <small class="text-danger d-block">{{ $message }}</small>
                                            @enderror
                                        </div>
