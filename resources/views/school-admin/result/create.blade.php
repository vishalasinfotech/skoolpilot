            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Result</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">Create Result</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('school-admin.result.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-select name="exam_schedule_id" id="exam_schedule_id" :options="$examSchedules" :value="old('exam_schedule_id')" required placeholder="Select Exam Schedule" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="number" name="total_marks" id="total_marks" :value="old('total_marks', 100)" min="1" step="0.01" required />
                                        @error('total_marks')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="number" name="obtained_marks" id="obtained_marks" :value="old('obtained_marks')" min="0" step="0.01" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="number" name="percentage" id="percentage" :value="old('percentage')" min="0" max="100" step="0.01" placeholder="Auto-calculated" />
                                        @error('percentage')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="remarks" id="remarks" rows="3" placeholder="Enter remarks">{{ old('remarks') }}</x-textarea>
                                        @error('remarks')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
