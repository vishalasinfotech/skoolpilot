            ...
            <div class="row mt-4">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('teacher.assignment.update', $assignment->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('academic_class_id') is-invalid @enderror" id="academic_class_id" name="academic_class_id" required>
                                            ...
                                            @foreach($classes as $id => $name)
                                                <option value="{{ $id }}" {{ old('academic_class_id', $assignment->academic_class_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('section_id') is-invalid @enderror" id="section_id" name="section_id">
                                            ...
                                            @foreach($sections as $id => $name)
                                                <option value="{{ $id }}" {{ old('section_id', $assignment->section_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                                            @endforeach
                                        </select>
                                        @error('section_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $assignment->title) }}" placeholder="Enter assignment title" required>
                                        @error('title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="4" placeholder="Enter assignment description" required>{{ old('description', $assignment->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <textarea class="form-control @error('instructions') is-invalid @enderror" id="instructions" name="instructions" rows="3" placeholder="Enter assignment instructions (optional)">{{ old('instructions', $assignment->instructions) }}</textarea>
                                        @error('instructions')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('max_marks') is-invalid @enderror" id="max_marks" name="max_marks" value="{{ old('max_marks', $assignment->max_marks) }}" placeholder="Enter maximum marks" min="0" max="1000">
                                        @error('max_marks')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        @if($assignment->attachment)
                                            <div class="mb-2">
                                                <a href="{{ \Illuminate\Support\Facades\Storage::url($assignment->attachment) }}" target="_blank" class="btn btn-sm btn-info">
                                                    <i class="ri-file-line me-1"></i> View Current Attachment
                                                </a>
                                            </div>
                                        @endif
                                        ...
                                        <small class="text-muted">Accepted formats: PDF, DOC, DOCX, JPG, JPEG, PNG (Max: 10MB). Leave empty to keep current file.</small>
                                        @error('attachment')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="ri-save-line align-middle me-1"></i> Update Assignment
                                        </button>
