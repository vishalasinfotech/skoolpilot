            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Holiday Management</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('school-admin.holiday.create') }}" class="btn btn-primary">
                                <i class="ri-add-line align-middle me-1"></i> Add Holiday
                            </a>
                        </div>
                        @livewire('school-admin.holiday-table')
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        <h4 class="mb-3">Delete Holiday</h4>
                        <p class="text-muted mb-4">
                            Are you sure you want to delete <strong id="deleteHolidayName"></strong>?
                            This action cannot be undone.
                        </p>
                        <div class="hstack gap-2 justify-content-center">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-danger" id="confirmDeleteBtn">Delete Holiday</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('livewire:init', function () {
            ...
            Livewire.on('openDeleteModal', (data) => {
                deleteHolidayId = data[0].holidayId;
                document.getElementById('deleteHolidayName').textContent = data[0].holidayName;
            ...
            document.getElementById('confirmDeleteBtn').addEventListener('click', function() {
                if (deleteHolidayId) {
                    ...
                    if (livewireElement) {
                        ...
                        if (component) {
                            component.call('delete', deleteHolidayId);
