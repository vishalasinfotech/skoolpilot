            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Holiday</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h5 class="card-title mb-0">Create Holiday</h5>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('school-admin.holiday.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <x-textarea name="description" id="description" rows="3" placeholder="Enter holiday description">{{ old('description') }}</x-textarea>
                                        @error('description')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
