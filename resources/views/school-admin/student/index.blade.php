...
@section('title', __('common.student_management'))
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ __('common.student_management') }}</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('common.students') }}</a></li>
                                <li class="breadcrumb-item active">{{ __('common.all_students') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('school-admin.student.create') }}" class="btn btn-primary">
                                    <i class="ri-add-line align-middle me-1"></i> {{ __('common.add_student') }}
                                </a>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="mt-4">
                        <h4 class="mb-3">{{ __('common.delete_student') }}</h4>
                        <p class="text-muted mb-4">
                            {{ __('common.are_you_sure_delete') }} <strong id="deleteStudentName"></strong>?<br>
                            {{ __('common.action_cannot_undone') }}
                        </p>
                        <div class="hstack gap-2 justify-content-center">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">{{ __('common.cancel') }}</button>
                            <button type="button" class="btn btn-danger" id="confirmDeleteBtn">{{ __('common.delete_student') }}</button>
                        </div>
                    </div>
                </div>
            </div>
