                            ...
                            <form action="{{ route('school-admin.student.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-input type="text" name="admission_number" id="admission_number" :value="old('admission_number')" required placeholder="Enter admission number" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="phone" id="phone" :value="old('phone')" placeholder="Enter student phone number" />
                                        @error('phone')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="parent_name" id="parent_name" :value="old('parent_name')" placeholder="Enter parent/guardian name" />
                                        @error('parent_name')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="email" name="parent_email" id="parent_email" :value="old('parent_email')" placeholder="Enter parent email address" />
                                        @error('parent_email')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-input type="text" name="parent_phone" id="parent_phone" :value="old('parent_phone')" placeholder="Enter parent phone number" />
                                        @error('parent_phone')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-input type="date" name="date_of_birth" id="date_of_birth" :value="old('date_of_birth')" />
                                        @error('date_of_birth')
                                            <small class="text-danger d-block">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <x-input type="date" name="admission_date" id="admission_date" :value="old('admission_date')" />
