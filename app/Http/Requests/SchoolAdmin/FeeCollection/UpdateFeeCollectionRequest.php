...
class UpdateFeeCollectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'upi_name' => ['nullable', 'required_if:payment_method,online', 'string', 'max:255'],
            'upi_id' => ['nullable', 'required_if:payment_method,online', 'string', 'max:255'],
            'remarks' => ['nullable', 'string', 'max:1000'],
            'receipt_number' => ['nullable', 'string', 'max:100', Rule::unique('student_fee_transactions', 'receipt_number')->ignore($transactionId)],
    ...
    public function messages(): array
    {
        return [
            ...
            'payment_method.in' => 'Payment method must be cash, online, or cheque.',
            ...
            'upi_name.required_if' => 'UPI name is required when payment method is online.',
            'upi_id.required_if' => 'UPI ID is required when payment method is online.',
